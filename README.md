...
Desarrollar un componente de precios siguiendo el proyecto de [Frontend Mentor](https://www.frontendmentor.io/challenges/pricing-component-with-toggle-8vPwRMIC).
